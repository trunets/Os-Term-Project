 ...
 * 
 * ================================================================
 * ยังขาดการเก็บและจัดการคิวจริง
 * ยังขาด FCFS
 * ยังขาด Priority Scheduling
 * ยังขาด tie-break เมื่อ priority เท่ากัน โดยต้องไม่ขึ้นกับว่า Thread ไหนเข้าคิวก่อน
 * ยังขาดการรอแบบไม่ใช้ busy waiting
 * ยังขาด size() ที่อ่านได้อย่าง thread-safe
